...
for ortho in [False,True]:
    for ANGULAR_SIMPLICITY_MODE0 in ['increase','decrease']:
        ...
        #=================================================
        invert_angular_simplicity.opts.set_and_lock('ANGULAR_SIMPLICITY_MODE',ANGULAR_SIMPLICITY_MODE)
        #=================================================
        invert_angular_simplicity.opts.unlock('ORTHOGONALIZE_TO_MAG')
        invert_angular_simplicity.opts.ORTHOGONALIZE_TO_MAG = ortho
        invert_angular_simplicity.opts.lock('ORTHOGONALIZE_TO_MAG')
        #=================================================
        sparsity.opts.unlock('angular_lambdas')
        sparsity.opts.angular_lambdas = [1000 for _ in range(5)]
        sparsity.opts.lock('angular_lambdas')        
        #=================================================
        ...
        #=================================================
        invert_angular_simplicity.MINOR_PREFIX = f'only_angular_{ANGULAR_SIMPLICITY_MODE0}{"_ortho" if ortho else "_no_ortho"}'
