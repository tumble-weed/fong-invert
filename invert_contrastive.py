...
#             acts = get_acts(model, x_)
        ...
        if method == 'fong':
            ...
            tot_loss = alpha_lambda*alpha_term + tv_lambda*tv_term + loss_lambda*(loss_term -loss_term2)+ score_sparsity_lambda*score_sparsity
        else:
            tot_loss = loss_term
        # tot_loss = loss_term
        #===============================================================
        ...
        if (i+1) % print_iter == 0:
            ...
            for lname in ['cam0_norm','cam0_sparsity','cam_norm','cam_tv','tv_term','loss_term','loss_term2','entropy','kl_from_start','kl_from_prev','change_in_mpool_from_prev','bg_entropy','x_entropy']:
